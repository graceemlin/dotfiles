...
(defcustom ews-org-heading-level-capitalize nil
  "Minimum level of Org headings to be capitalized.
'nil implies all levels are capitalized."
  :group 'ews
...
Customize `titlecase-style' for styling."
  (interactive "P")
  (require 'titlecase)
  (let ((style (if arg 'sentence titlecase-style)))
    ...
    (org-map-entries
	 ...
	 (when (<= level (or ews-org-heading-level-capitalize 999))
